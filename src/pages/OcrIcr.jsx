          ...
          <div className="mt-10 grid grid-cols-1 gap-3 midFM:grid-cols-2 items-center justify-center mb-10">
            ...
            <div className="midFM:order-1 col-span-2">
              ...
              <p className="text-sm midxmd:text-lg font-poppins mt-1">
                ...
                identification and verification. With an impressive accuracy
                rate of 90% or above, our model's greatest advantage is its
              ...
              <ul>
                ...
                <li className="flex gap-1 items-center justify-center">
                  ...
                  <p className="text-sm midxmd:text-lg font-poppins mt-1">
                    ...
                    analyzed, or stored in a database, enhancing efficiency and
                    accuracy.
                  </p>
                </li>
                <li className="flex gap-1 items-center justify-center">
                  ...
                  <p className="text-sm midxmd:text-lg font-poppins mt-1">
                    ...
                    management, ERP, or CRM systems, enabling efficient data
                    flow and reducing manual data entry requirements.
                  </p>
                </li>
              </ul>
              <Link
            ...
            <div className="mt-10 flex flex-col gap-10">
              <div className="text-sm midFM:text-2xl font-poppins">
                <p>
                  ...
                  different types of documents into editable and searchable
                  data. However, they are designed to handle different types of
                  text and have different levels of complexity in their
                  operation.
                </p>
              </div>
              <div className="text-sm midFM:text-2xl font-poppins">
                <p>
                  ...
                  analyzing the shapes and patterns of the letters in the
                  scanned image of a document. The OCR software compares these
                  shapes and patterns with those in its database (which contains
                  the shapes and patterns of each character in a particular
                  font). When it finds a match, it converts the image of the
                  character into an editable text character. OCR is highly
                  accurate when used to read printed text, but its accuracy
                  decreases significantly when used to read handwriting.
                </p>
              </div>
              <div className="text-sm midFM:text-2xl font-poppins">
                <p>
              ...
              <div className="text-sm midFM:text-2xl font-poppins">
                <p>
                  ...
                  machine learning and AI to enhance accuracy and adaptability
                  to varying handwriting styles and fonts.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mt-5 grid grid-cols-1 gap-5 items-center justify-center midFM:grid-cols-2">
              <div className="order-1 midFM:col-span-2">
                <p className="font-poppins500 text-lg">
                  At MappOptimist Technologies, We have developed a specialized
                  AI model specifically designed for Indian eKYC identification
                  and verification. Boasting an accuracy rate of 90% or higher,
                  our model's key strength lies in its adaptiveness. It
                  effortlessly processes text regardless of orientation or
                  format changes, consistently producing accurate results. The
                  model proficiently identifies the following types:
                </p>
              </div>
