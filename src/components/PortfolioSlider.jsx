        ...
        <div
          className={`opacity-0 ${
            index === currentSlideIndex
              ...
              : ""
          } h-[35rem] mt-1 absolute inset-0 transition-all delay-75 ease-in-out rounded-[3rem] overflow-hidden w-full xl:w-[64%] midXl:w-[59.3%] xxl:w-[58.6%] midxmd:ml-[5.3rem]`}
        >
