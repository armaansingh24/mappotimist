  ...
  return (
    <>
      ...
      >
        ...
        />
        <div className="opacity-0 group-hover:opacity-[1] group-hover:bg-[rgb(0,0,0,0.7)] xxmd:h-auto absolute top-[1rem] bottom-[3.8rem] md:bottom-[5.4rem] xxmd:bottom-[4.84rem] left-[-.2rem] right-0 group-hover:scale-[1.06] transition-all delay-500 ease-in-out rounded-lg">
