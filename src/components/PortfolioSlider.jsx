        ...
        <div
          className={`opacity-0 ${
            index === currentSlideIndex
              ...
              : ""
          } h-[35rem] mt-2 absolute inset-0 transition-all delay-75 ease-in-out rounded-[3rem] overflow-hidden w-[96%] middleXmd:w-[90%] xl:w-[77%] midXl:w-[72%]  midxmd:ml-[01rem] hidden middleXmd:block`}
        >
