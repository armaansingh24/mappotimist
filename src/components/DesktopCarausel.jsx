        ...
        <div
          className={`opacity-0 ${
            index === currentSlideIndex
              ...
              : ""
          } h-[13rem] mt-24 absolute inset-0 transition-all delay-75 ease-in-out rounded overflow-hidden w-full xl:w-[99%]  midXl:w-[99.8%] xxl:w-[96%] midlg:w-[90%] hidden middleXmd:block`}
        >
